...
const colorMap = {
  blue: { from: '#93c5fd', to: '#2563eb', ring: '#60a5fa' },
...
export default function HowItWorks() {
  return (
    <section className="py-24 px-6 bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute -top-24 -left-24 w-96 h-96 rounded-full blur-3xl opacity-30" style={{ background: 'radial-gradient(circle, rgba(96,165,250,0.7), rgba(96,165,250,0))' }} />
      <div className="pointer-events-none absolute -bottom-24 -right-24 w-96 h-96 rounded-full blur-3xl opacity-30" style={{ background: 'radial-gradient(circle, rgba(59,130,246,0.7), rgba(59,130,246,0))' }} />

      <div className="max-w-7xl mx-auto relative">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-5xl md:text-6xl font-bold">
            <span className="bg-gradient-to-r from-blue-200 via-blue-300 to-cyan-300 bg-clip-text text-transparent">How it works</span>
          </h2>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative group">
              ...
              {index < steps.length - 1 && (
                <div className="hidden md:block absolute top-20 left-[calc(50%+40px)] w-[calc(100%-80px)] h-0.5 bg-gradient-to-r from-blue-400/70 via-blue-400/40 to-transparent" />
              )}
